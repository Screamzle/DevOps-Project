...
class Workout_Names(db.Model):
    ...
    # creating relationship with Workout Plans
    workout_names = db.relationship('Workout_Plans', backref="workout_name')
...
class Workout_Plans(db.Model):
    ...
    workout_name = db.Column(db.String(30), db.ForeignKey('Workout__Names.workout_name'), nullable=False) # FK workout_names
